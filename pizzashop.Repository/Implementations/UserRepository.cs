...
public class UserRepository : IUserRepository
{
    ...
    {
        return await _context.Userslogins.AnyAsync(u => u.Email.Trim() == email.Trim() && u.User.Isdeleted == false);
    }

    public async Task<bool> UsernameExistsAsync(string Username)
    {
        return await _context.Userslogins.AnyAsync(u => u.Username.Trim() == Username.Trim() && u.User.Isdeleted == false);
    }

     public async Task<bool> UsernameExistsEditAsync(string Username,int userid)
    {
        return await _context.Userslogins.AnyAsync(u => u.Username.Trim() == Username.Trim() && u.Userid!=userid && u.User.Isdeleted == false);
    }
